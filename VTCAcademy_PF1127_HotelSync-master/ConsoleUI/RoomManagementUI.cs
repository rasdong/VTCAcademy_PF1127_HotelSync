...
namespace HotelManagementSystem
{
    public class RoomManagementUI : BaseUI
    {
        ...
        private void ShowAddRoom()
        {
            ...
            Console.SetCursorPosition(x + 2, y + 10);
            Console.Write("Tiện nghi ( ví dụ: [\"TV\", \"WiFi\"]): ");
            string? amenities = ReadInputWithEscape(x + 38, y + 10);
            ...
            try
            {
                ...
                // Ghi log thêm phòng thành công
                SimpleLogger.LogActivity(currentUsername ?? "Unknown", "Add Room", 
                    $"Added room {roomNumber}, type: {roomType}, price: {priceInput}, ID: {roomId}");
            ...
            {
                // Lỗi đã được log trong ShowErrorMessage của BaseUI
                ShowErrorMessage(ex.Message);
                Console.ReadKey();
            }
        }
        ...
        private void ShowUpdateRoom()
        {
            ...
            SetupBox(82, 18); // Mở rộng box từ 16 lên 18
            ...
            Console.SetCursorPosition(x + 2, y + 12);
            Console.Write("Tiện nghi (ví dụ: [\"TV\", \"WiFi\"]): ");
            string? amenities = ReadInputWithEscape(x + 38, y + 12);
            if (amenities == null) return;
            ...
            string? status = ReadInputWithEscape(x + 64, y + 14);
