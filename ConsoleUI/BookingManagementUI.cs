...
namespace HotelManagementSystem
{
    public class BookingManagementUI : BaseUI
    {
        ...
        private void ShowExtendBooking()
        {
            ...
            Console.SetCursorPosition(x + 2, y + 6);
            Console.Write("Ngày check-out mới (dd/MM/yyyy): ");
            string? newCheckOutDateInput = ReadInputWithEscape(x + 34, y + 6);
            if (newCheckOutDateInput == null) return;

            try
            {
                DateTime newCheckOutDate = DateTime.Parse(newCheckOutDateInput);
        ...
        private void ShowBookingHistory()
        {
            ...
            try
            {
                ...
                string[] headers = new[] { "ID", "Khách hàng", "Phòng", "Check-in", "Check-out", "Trạng thái" };
