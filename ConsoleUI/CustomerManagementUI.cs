    ...
    public class CustomerManagementUI : BaseUI
    {
        ...
        public void ShowCustomerManagement()
        {
            while (true)
            {
                ...
                Console.Write($"Ngày: {DateTime.Now:yyyy-MM-dd HH:mm:ss} (GMT+7)");
                ...
                string? choice = ReadInputWithEscape(x + 12, y + height - 2);
                if (choice == null)
                    return;
        ...
        private void ShowSearchCustomer()
        {
            ...
            Console.SetCursorPosition(x + 2, y + 14);
            Console.Write("Lựa chọn: ");
            string? choice = ReadInputWithEscape(x + 12, y + 14);
            ...
            try
            {
                ...
                switch (choice)
                {
                    case "1":
                        ...
                        searchTerm = ReadInputWithEscape(x + 20, y + 16) ?? "";
                    ...
                    case "2":
                        ...
                        searchTerm = ReadInputWithEscape(x + 18, y + 16) ?? "";
                        if (!string.IsNullOrEmpty(searchTerm))
                        {
                    ...
                    case "3":
                        ...
                        searchTerm = ReadInputWithEscape(x + 21, y + 16) ?? "";
                        if (!string.IsNullOrEmpty(searchTerm))
                        {
        ...
        {
            Console.Clear();
            DrawHeader("Hệ Thống Quản Lý Khách Sạn - Kết Quả Tìm Kiếm Khách Hàng");
            SetupBox(120, 25);
