...
using HotelManagementSystem; // Thêm dòng này để sử dụng ServiceManagement trực tiếp
...
namespace HotelManagementSystem
{
    public class ConsoleUI
    {
        ...
        private void ShowEmployeeManagement()
        {
            ...
            {
                staffManager = new StaffManagement(currentRole ?? string.Empty, currentUserId, currentUsername ?? string.Empty);
            }
                ...
                if (currentUsername == null)
                {
                    ...
                    if (choice == "1")
                    {
                        ...
                        if (Login(username, password))
                        {
                            ...
                            Thread.Sleep(1000);
                            Console.Clear();
                            customerManager = new CustomerManagement(currentRole ?? string.Empty, currentUserId, currentUsername ?? string.Empty);
                            staffManager = new StaffManagement(currentRole ?? string.Empty, currentUserId, currentUsername ?? string.Empty);
                        }
                        else
                        {
